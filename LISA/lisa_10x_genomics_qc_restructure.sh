...
# (1) Execute Python script with the following arguments:
...
# (2) File export
mv lisa_10x_1M_qc_restructure.log ${out_dir} # Move log file to output directory
mv 10x_1M_neurons_qc.h5ad ${out_dir} # Move processed H5AD object to output directory
