...
# INPUT:    file_path_10x_genomics_lvl1: Combined GWAS DEPICT results for 10x Genomics dataset
# INPUT:    file_path_karolinska_lvl1: Combined GWAS DEPICT results for Karolinska Institute dataset
