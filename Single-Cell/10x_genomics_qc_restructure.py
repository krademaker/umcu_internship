...
genome='mm10'
filename_out='1M_neurons_neuron_20k_qc_avg_std_celltype.csv'
...
# Determine cell quality metrics (percentage mitochondrial genes, n.o. counts, n.o. genes)
...
sc_data=sc_data[sc_data.obs['percent_mito'] < 0.1,:] # Retain cells with fewer than 10% mitochondrial genes
...
sc_data_standardized_by_celltype.to_csv(filename_out, skip_blank_lines=True, sep='\t') # Export file
