...
wget https://data.broadinstitute.org/alkesgroup/LDSCORE/w_hm3.snplist.bz2 -P ${files_dir}
bzip2 -d ${files_dir}/w_hm3.snplist.bz2
tail -n+2 ${files_dir}/w_hm3.snplist | cut -f1 > ${files_dir}/w_hm3.snplist.snps
# Declare variables
...
for ct in ${cell_types[@]}; do
	...
	for chr in {1..22}; do
		...
		python ${ldsc_dir}/ldsc.py \
			...
			--thin-annot \
			--print-snps ${files_dir}/w_hm3.snplist.snps \
