...
# INPUT:	Gene sets of Ensembl IDs for human genes in a given sub-annotation, as generated by the 'generate_geneset_files.R' script
...
wget https://data.broadinstitute.org/alkesgroup/LDSCORE/make_annot_sample_files/ENSG_coord.txt -P ${files_dir}
...
# Declare variables
gene_coord_file=${files_dir}/ENSG_coord.txt
